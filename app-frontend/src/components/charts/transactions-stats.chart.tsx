...
// Trades data for B2B Software Company (6 months)
const salesData = [
      ...
      <CardHeader className="border-0 min-h-auto pt-6 pb-6">
        ...
        <CardToolbar>
          <div className="flex items-center gap-4 text-sm">
            <ChartLabel label="Trades" color={chartConfig.sales.color} />
            <ChartLabel label="Deals" color={chartConfig.goals.color} />
          </div>
          <DropdownMenu>
      ...
      <CardContent className="px-2.5 flex flex-col items-end">
        ...
        >
          ...
          >
            ...
            {/* Trades area with gradient background */}
            <Area
              type="linear"
              dataKey="salesArea"
              stroke="transparent"
